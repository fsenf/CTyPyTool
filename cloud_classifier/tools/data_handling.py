...
def set_indices_from_mask(filename, selected_mask):
    """
...
def add_training_files(filename_data, filename_labels):
    """
...
def create_training_set(training_sets = None, masked_indices = None):
    """
...
def extract_labels(filename, indices = None, hour = 0):
    """
...
def create_input_vectors(filename, hour=0):
    """
...
def make_xrData(labels, indices, reference_file = None, NETCDF_out = None, 
        prob_data = None):
    """
...
def save_mask_indices(filename):
...
def save_training_set(vectors, labels, filename):
    """
...
def check_nwcsaf_version(labels = None, filename = None, verbose = True):
    """
...
def plot_data(label_file, reduce_to_mask = True , extent= None,  cmap = "hot", mode = "label", 
...
def plot_probas(label_file, truth_file = None, georef_file = None, reduce_to_mask = True, 
...
def plot_multiple(label_files, truth_file = None, georef_file = None, 
...
def get_plotable_data(input_data = None, data_file = None, georef_file = None, 
